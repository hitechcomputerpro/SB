...
'''
    ...
    raw_response = client.chat.completions.create(
        model="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",
        messages=[{
            "role": "user",
            "content": prompt
        }],
...
def generate_email(probability, input_dict, explanation, surname):
    ...
    raw_response = client.chat.completions.create(
        model="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",
        messages=[
            {
                "role": "user",
                "content": prompt
